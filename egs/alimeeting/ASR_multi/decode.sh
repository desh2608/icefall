...
# This script uses pretrained AliMeeting model to decode AMI GSS-enhanced audio,
...
EXP_DIR=pruned_transducer_stateless7/exp/alimeeting${rttm_affix}${gss_affix}
...
if [ $stage -le 1 ] && [ $stop_stage -ge 1 ]; then
  ...
  for split in eval test; do
    ref_file=data/manifests/alimeeting-sdm_supervisions_${split}.jsonl.gz
